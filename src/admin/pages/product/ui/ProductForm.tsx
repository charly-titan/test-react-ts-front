...
import type { Product, Size } from "@/interfases/product.interface"
...
export const ProductForm = ({ title, subtTitle, product,onSubmit,isPending}: Props) => {

  const [files, setFiles] = useState<File[]>([]);

    const inputTagRefs = useRef<HTMLInputElement>(null);
  ...
  useEffect(() => {
    ...
    const addTag = () => {
        const newTag = inputTagRefs.current!.value;
    ...
    const removeSize = (size: Size) => {
      ...
      const handleDrop = (e: React.DragEvent) => {
        ...
        setFiles((prev: any)=>[...prev,...Array.from(files)])
    ...
    return (
        ...
        <div className="flex justify-between items-center">
          <AdminTitle title={title} subtitle={subtTitle} />
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                                        ...
                                        {...register('slug', {
                                            required: true,
                                            validate: (value)=> !/\s/.test(value) || 'El slug no permite espacios en blanco'
                                        })}
                                    ...
                                    />
                                    {
                                        errors.slug && (
                                            ...
                                            <p className="text-red-500 text-sm">
                                                {errors.slug.message || 'El slug del producto es requerido'}
